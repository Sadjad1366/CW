...
<div className="w-full grid grid-cols-2 gap-x-44 mx-auto bg-bgc-base px-20">
      {/* ====== LEFT SIDE =============== */}
      <div className=" w-full my-28 items-start flex flex-col">
            ...
            <button className="my-2 text-[11.14px] font-medium bg-primary-green text-white px-6 h-[36.49px] rounded-[2.78px]">Register</button>
      </div>
      {/* ============RIGHT SIDE ============== */}
